		...
		while(1){ ; search news icon is re
			needle=Facebook - Mozilla Firefox ahk_class MozillaWindowClass
			t_1_FacebotText:="|<>4267B2-000000$35.z0000Ty0000zw0001zk0003zU00Dzy000Dzs000Tzk000zzU001zz0003zz0007zzz0Tzzzy0Tzzzw0zzzzs3zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzy"
			;t_2_FacebotText:=t_1_FacebotText
			;t_2_FacebotText:="|<>**50$21.04z00U004000U003U0020008001U004000U00A0030zzk6300Mk01w00U"
			SetTitleMatchMode,2
			WinGetPos, wX, wY, wW, wH, % needle ; https://www.autohotkey.com/boards/viewtopic.php?f=6&t=17834&p=271791#p271791
	;WinActivate,% needle
			WinWaitActive,% needle
			sleep,200
			;if (ok:=FindText(0, 0, A_ScreenWidth, A_ScreenHeight, 0, 0, t_1_FacebotText)){
			if(ok:=FindText(wX+wW//2, wY+60, wX+wW-wW//2, 400, 0, 0, t_1_FacebotText)){ ; findTextTool_demo_backwardsLoop_bottomTooTop(ok)
